...
export default function ShareButtons({ videoId, videoTitle }: ShareButtonsProps) {
  ...
  const shareLinks = [
    ...
    {
      name: "Email",
      url: `mailto:?subject=${encodedTitle}&body=Check out this video: ${encodedUrl}`,
      color: "#EA4335",
      icon: (
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
      ...
      {showEmbed && (
        <div style={{
          ...
          <button
            onClick={() => copyToClipboard(`<iframe src="${embedUrl}" width="640" height="360" frameborder="0" allowfullscreen></iframe>`)}
            style={{
              marginTop: "0.5rem",
