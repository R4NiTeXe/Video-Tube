...
export default function MobileRegisterPage() {
  ...
  const handleSendOTP = async () => {
    ...
    setIsLoading(true);
    try {
      await api.post("/users/mobile/send-registration-otp", {
        mobile: fullMobile,
      });
      setStep("otp");
      setCooldown(60);
  ...
  const handleVerifyOTP = async () => {
    ...
    setIsLoading(true);
    try {
      await api.post("/users/mobile/verify-registration-otp", {
    ...
    return (
      <>
        <PageMeta
          ...
          description="Register your VideoTube account using mobile verification."
          noIndex
        />
        <div
          style={{
