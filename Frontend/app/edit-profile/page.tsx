...
export default function EditProfilePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.patch("/users/profile", {
        bio: bio.trim(),
        socialLinks: { youtube, twitter, instagram, github, website },
      });
      if (avatarFile) {
  ...
  return (
    <main style={{ minHeight: "100vh", backgroundColor: "var(--bg-primary)" }}>
      <PageMeta
        title="Edit Profile"
        description="Update your VideoTube profile."
        noIndex
      />
      <div
        className="edit-profile-wrapper content-max"
                        ...
                        <div style={{ position: "relative" }}>
                          <input
                            ...
                            style={{
                              width: "100%",
                              boxSizing: "border-box",
                              paddingRight: field.value ? "2rem" : undefined,
                            }}
                            value={field.value}
                            onChange={(e) => {
