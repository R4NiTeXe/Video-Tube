        ...
        >
          ...
          >
            ...
            >
              ...
              <textarea
                placeholder="gaming, tutorial, comedy"
                className="input"
                value={tagsInput}
          ...
          >
            ...
            >
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      ...
                      if (file.size > MAX_VIDEO_MB * 1024 * 1024) {
                        setError(
                          `Video size must be ${MAX_VIDEO_MB} MB or less`,
                        );
                      } else {
                        setError("");
                      }
              ...
              <div className="upload-zone">
                  ...
                  onChange={(e) => {
                    ...
                    if (file) {
                      ...
                      if (file.size > MAX_THUMBNAIL_MB * 1024 * 1024) {
                        setError(
                          `Thumbnail size must be ${MAX_THUMBNAIL_MB} MB or less`,
                        );
                      } else {
                        setError("");
                      }
                ...
                <p className="upload-zone-hint">
                  JPG, PNG, WEBP (max {MAX_THUMBNAIL_MB} MB)
                </p>
              </div>
            </div>
          </div>
