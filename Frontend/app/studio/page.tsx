...
function EmptyVideosState({ onUpload }: { onUpload: () => void }) {
  return (
    ...
    >
      ...
      >
        Your creator journey starts here. Upload your first video and begin
    ...
    >
      ...
      >
        ...
        >
          ...
          <strong style={{ color: "var(--text-primary)" }}>{videoTitle}</strong>
...
function CreatorStudioContent() {
  ...
  const likesPerVideo =
    stats.totalVideos > 0
      ? Math.round(stats.totalLikes / stats.totalVideos)
      : 0;
  const engagementPct =
    stats.totalViews > 0 ? Math.min(parseFloat(engagementRate), 100) : 0;
  ...
  return (
    <>
      <PageMeta
        ...
        description="Manage your videos and channel analytics."
        noIndex
      />
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Manage your videos, audience, analytics and channel
                  performance.
                </p>
              </div>
              <button
              ...
              >
                ...
                >
                  {[
                    ...
                    {
                      label: "Watch Time",
                      value: `${stats.totalWatchTime || 0}m`,
                      pct: watchTimePct,
                    },
                    {
                      label: "Likes per Video",
                      value: `${likesPerVideo}`,
                      pct: likesPerVideoPct,
                    },
                    {
                      label: "Avg Views",
                  ...
                  {sortedVideos.slice(0, 5).map((v: any) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          {v.isPublished ? "Video uploaded" : "Draft saved"}
                        </span>
                        {!isMobile && (
                          <span
                            style={{
                      ...
                      {sortedVideos.map((video: any, i: number) => (
                        ...
                        >
                          ...
                          >
                            ...
                            <button
                              onClick={() => setDeletingVideo(video._id)}
                              style={{
                                width: 26,
                                height: 26,
                                padding: 0,
